...
import copy
import time
from model import ResNet18,ResidualBlock
...
def train_model_process(model,train_loader,val_loader,num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        print("训练和验证耗费的时间{:.0f}m{:.0f}s".format(cost_time//60, cost_time%60))

    #训练以及验证完成后保存模型
    torch.save(best_model_wts,'ResNet18_model.pth')
...
if __name__ == '__main__':
    ...
    #开始训练
    train_process=train_model_process(net,train_loader,val_loader,10)
    #绘制图像
